...
train_data = datasets.FashionMNIST('./week13/data/fashionmnist', train = True, transform = transform, download = True)
test_data = datasets.FashionMNIST('./week13/data/fashionmnist', train = False, transform = transform, download = True)
...
torch.save(G.state_dict(),f'pt/fashionmnist_cGenerator{epoch}.pt')
