...
G_B2A.load_state_dict(torch.load('weights_200/netG_B2A.pth', map_location = torch.device('cpu')))
G_B2A.eval()
...
if __name__ == '__main__':
    ...
    for i, data in progress_bar:
        ...
        vutils.save_image(fake_image.detach(), f"output/fake_image_200_128x128.jpg", normalize = True)